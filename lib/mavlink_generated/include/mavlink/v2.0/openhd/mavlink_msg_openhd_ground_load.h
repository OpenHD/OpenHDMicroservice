...
#define MAVLINK_MSG_ID_OPENHD_GROUND_LOAD_CRC 233
#define MAVLINK_MSG_ID_1231_CRC 233
...
#define MAVLINK_MESSAGE_INFO_OPENHD_GROUND_LOAD { \
    ...
    "OPENHD_GROUND_LOAD", \
    4, \
    {  { "cpuload", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_openhd_ground_load_t, cpuload) }, \
         { "temp", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_openhd_ground_load_t, temp) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_openhd_ground_load_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_openhd_ground_load_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_GROUND_LOAD { \
...
{
    return mavlink_msg_openhd_ground_load_pack(system_id, component_id, msg, openhd_ground_load->cpuload, openhd_ground_load->temp, openhd_ground_load->target_system, openhd_ground_load->target_component);
}
...
{
    return mavlink_msg_openhd_ground_load_pack_chan(system_id, component_id, chan, msg, openhd_ground_load->cpuload, openhd_ground_load->temp, openhd_ground_load->target_system, openhd_ground_load->target_component);
}
...
static inline void mavlink_msg_openhd_ground_load_send(mavlink_channel_t chan, uint8_t cpuload, uint8_t temp, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_GROUND_LOAD_LEN];
    _mav_put_uint8_t(buf, 0, cpuload);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_openhd_ground_load_send(chan, openhd_ground_load->cpuload, openhd_ground_load->temp, openhd_ground_load->target_system, openhd_ground_load->target_component);
#else
 ...
 */
static inline void mavlink_msg_openhd_ground_load_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t cpuload, uint8_t temp, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

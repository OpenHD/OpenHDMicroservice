...
#define MAVLINK_MSG_ID_OPENHD_WIFI_STATUS_CRC 131
#define MAVLINK_MSG_ID_1212_CRC 131
...
#define MAVLINK_MESSAGE_INFO_OPENHD_WIFI_STATUS { \
    ...
    {  { "wifi_adapter_cnt", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_openhd_wifi_status_t, wifi_adapter_cnt) }, \
         ...
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_openhd_wifi_status_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_openhd_wifi_status_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_WIFI_STATUS { \
...
static inline uint16_t mavlink_msg_openhd_wifi_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t wifi_adapter_cnt, const int8_t *current_signal_dbm, const uint8_t *wifi_card_type, const uint32_t *received_packet_cnt, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_WIFI_STATUS_LEN];
    _mav_put_uint8_t(buf, 16, wifi_adapter_cnt);
    _mav_put_uint8_t(buf, 25, target_system);
...
{
    return mavlink_msg_openhd_wifi_status_pack(system_id, component_id, msg, openhd_wifi_status->wifi_adapter_cnt, openhd_wifi_status->current_signal_dbm, openhd_wifi_status->wifi_card_type, openhd_wifi_status->received_packet_cnt, openhd_wifi_status->target_system, openhd_wifi_status->target_component);
}
...
{
    return mavlink_msg_openhd_wifi_status_pack_chan(system_id, component_id, chan, msg, openhd_wifi_status->wifi_adapter_cnt, openhd_wifi_status->current_signal_dbm, openhd_wifi_status->wifi_card_type, openhd_wifi_status->received_packet_cnt, openhd_wifi_status->target_system, openhd_wifi_status->target_component);
}
...
static inline void mavlink_msg_openhd_wifi_status_send(mavlink_channel_t chan, uint8_t wifi_adapter_cnt, const int8_t *current_signal_dbm, const uint8_t *wifi_card_type, const uint32_t *received_packet_cnt, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_WIFI_STATUS_LEN];
    _mav_put_uint8_t(buf, 16, wifi_adapter_cnt);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_openhd_wifi_status_send(chan, openhd_wifi_status->wifi_adapter_cnt, openhd_wifi_status->current_signal_dbm, openhd_wifi_status->wifi_card_type, openhd_wifi_status->received_packet_cnt, openhd_wifi_status->target_system, openhd_wifi_status->target_component);
#else
 ...
 */
static inline void mavlink_msg_openhd_wifi_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t wifi_adapter_cnt, const int8_t *current_signal_dbm, const uint8_t *wifi_card_type, const uint32_t *received_packet_cnt, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

...
#define MAVLINK_MSG_ID_OPENHD_AIR_LOAD_LEN 4
#define MAVLINK_MSG_ID_OPENHD_AIR_LOAD_MIN_LEN 4
#define MAVLINK_MSG_ID_1230_LEN 4
#define MAVLINK_MSG_ID_1230_MIN_LEN 4

#define MAVLINK_MSG_ID_OPENHD_AIR_LOAD_CRC 41
#define MAVLINK_MSG_ID_1230_CRC 41
...
#define MAVLINK_MESSAGE_INFO_OPENHD_AIR_LOAD { \
    ...
    {  { "cpuload", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_openhd_air_load_t, cpuload) }, \
         ...
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_openhd_air_load_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_openhd_air_load_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_AIR_LOAD { \
...
static inline uint16_t mavlink_msg_openhd_air_load_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t cpuload, uint8_t temp, uint8_t target_system, uint8_t target_component)
{
...
{
    return mavlink_msg_openhd_air_load_pack(system_id, component_id, msg, openhd_air_load->cpuload, openhd_air_load->temp, openhd_air_load->target_system, openhd_air_load->target_component);
}
...
{
    return mavlink_msg_openhd_air_load_pack_chan(system_id, component_id, chan, msg, openhd_air_load->cpuload, openhd_air_load->temp, openhd_air_load->target_system, openhd_air_load->target_component);
}
...
static inline void mavlink_msg_openhd_air_load_send(mavlink_channel_t chan, uint8_t cpuload, uint8_t temp, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_AIR_LOAD_LEN];
    _mav_put_uint8_t(buf, 0, cpuload);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_openhd_air_load_send(chan, openhd_air_load->cpuload, openhd_air_load->temp, openhd_air_load->target_system, openhd_air_load->target_component);
#else
 ...
 */
static inline void mavlink_msg_openhd_air_load_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t cpuload, uint8_t temp, uint8_t target_system, uint8_t target_component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_system from openhd_air_load message
 *
 * @return  system id of the requesting system
 */
static inline uint8_t mavlink_msg_openhd_air_load_get_target_system(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  2);
}

/**
 * @brief Get field target_component from openhd_air_load message
 *
 * @return  component id of the requesting component
 */
static inline uint8_t mavlink_msg_openhd_air_load_get_target_component(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_openhd_air_load_decode(const mavlink_message_t* msg, mavlink_openhd_air_load_t* openhd_air_load)
{
    ...
    openhd_air_load->target_system = mavlink_msg_openhd_air_load_get_target_system(msg);
    openhd_air_load->target_component = mavlink_msg_openhd_air_load_get_target_component(msg);
#else

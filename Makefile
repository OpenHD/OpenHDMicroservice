...
RTFusion.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTFusion.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTFusion.cpp

RTFusionRTQF.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTFusionRTQF.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTFusionRTQF.cpp

RTMath.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTMath.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTMath.cpp

RTFusionKalman4.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTFusionKalman4.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTFusionKalman4.cpp

RTIMUAccelCal.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUAccelCal.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUAccelCal.cpp

RTIMUHal.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUHal.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUHal.cpp

RTIMUMagCal.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUMagCal.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUMagCal.cpp

RTIMUSettings.o: $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUSettings.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/RTIMUSettings.cpp

RTIMU.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMU.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMU.cpp

RTIMUGD20M303DLHC.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20M303DLHC.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20M303DLHC.cpp

RTIMUGD20HM303DLHC.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20HM303DLHC.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20HM303DLHC.cpp

RTIMUGD20HM303D.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20HM303D.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUGD20HM303D.cpp

RTIMULSM9DS0.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMULSM9DS0.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMULSM9DS0.cpp

RTIMULSM9DS1.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMULSM9DS1.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMULSM9DS1.cpp

RTIMUMPU9150.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUMPU9150.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUMPU9150.cpp

RTIMUMPU9250.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUMPU9250.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUMPU9250.cpp

RTIMUBMX055.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUBMX055.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUBMX055.cpp

RTIMUBNO055.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUBNO055.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUBNO055.cpp

RTIMUNull.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUNull.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUNull.cpp

RTPressure.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressure.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressure.cpp

RTPressureBMP180.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureBMP180.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureBMP180.cpp

RTPressureLPS25H.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureLPS25H.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureLPS25H.cpp

RTPressureMS5611.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureMS5611.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureMS5611.cpp

RTPressureMS5637.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureMS5637.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTPressureMS5637.cpp

RTHumidity.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidity.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidity.cpp

RTHumidityHTS221.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidityHTS221.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidityHTS221.cpp

RTHumidityHTU21D.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidityHTU21D.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTHumidityHTU21D.cpp

RTIMUHMC5883LADXL345.o: $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUHMC5883LADXL345.cpp
	gcc -g -c -pthread $(SYSTEM_INCLUDE) $(INC_DIR) $(PWD)/lib/RTIMULib2/RTIMULib/IMUDrivers/RTIMUHMC5883LADXL345.cpp
